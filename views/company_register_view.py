...
def company_register_view(page: ft.Page):
    ...
    def do_register(e):
        ...
        new_proj = Project(id=p_id, name=p_name.value, company_id=c_id, company_name=c_name.value,
                           description="Primer proyecto registrado.", status="Active", technologies=["General"])
        ...
        new_job = JobOffer(id=j_id, title=j_title.value, company_id=c_id, company_name=c_name.value,
                           ...
                           required_skills=[], posted_date=datetime.now().strftime("%Y-%m-%d"), experience_level="Cualquiera")
    ...
    main_container = ft.Container(
        content=ft.Container(
            ...
            width=480, bgcolor=BG_SECONDARY, border_radius=20, border=ft.border.all(1, BORDER_COLOR), padding=40,
        ),
